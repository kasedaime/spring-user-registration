...
import com.example.user.registration.User.UserRole;
import com.example.user.registration.email.EmailSender;
...
import com.example.user.registration.validators.EmailValidator;
